...
import { getBlocks, createBlock } from '../../MongoRoutes/BlockRoutes.js';
                                ...
                                <Form onSubmit={e => {handleSubmit(e)}} className="pm_form">
                                    ...
                                    <Form.Group>
                                        ...
                                        <Form.Select onChange={e => setContract(e.target.value)}>
                                            <option disabled selected value> Select a Contract Code</option>
                                            {
                                ...
                                <tbody>
                                    {
                                        blocks.map((block) => 
                                            <tr>
                                                ...
                                                <td><Button value={block._id} onClick={e => deleteContract(block._id)} variant="danger">Delete</Button></td>
                                            </tr>
                                        )
                                    }
                                </tbody>
